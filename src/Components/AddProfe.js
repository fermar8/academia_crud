...
import { addProfesor } from '../Crud';

function AddProfe(props) {
...
const handleTornar = (modal) => {
    ...
    return (
     ...
     <Modal isOpen={modal} toggle={(modal) => handleTornar (modal)}>
        <ModalHeader>Afegeix un nou Professor</ModalHeader>
        <ModalBody>
        <Form style={{marginTop: "20px"}}>
            ...
            <ModalFooter>
            <Button color="success" onClick={(e) => addProfe (e)}>Guardar</Button>
